...
const QUERY_KEY = "official-pending-flags"
  ...
  return (
    <SafeAreaView style={sharedStyles.safe}>
      <FlatList
        ...
        ListHeaderComponent={<Text style={sharedStyles.heading}>Flag Review</Text>}
        ListEmptyComponent={
          <Text style={sharedStyles.empty}>No pending flags to review.</Text>
        }
        renderItem={({ item }) => (
